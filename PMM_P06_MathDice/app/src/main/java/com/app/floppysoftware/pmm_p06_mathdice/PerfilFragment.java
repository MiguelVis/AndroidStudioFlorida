...
public class PerfilFragment extends Fragment implements
    ...
    public void onActivityCreated (Bundle savedInstanceState) {
        ...
        // Tomar valores enviados al fragment
    ...
    public void onConnected(Bundle bundle) {
        ...
        // Si hay datos, actualizar la localización
    ...
    /**
     * Actualizar localización en pantalla.
     */
    ...
    public void refreshFoto() {
        ...
        class BitmapWorkerTask extends AsyncTask<String, Void, Bitmap> {
            ...
            protected Bitmap doInBackground(String... params) {
                ...
                // Crear un thumbnail del tamaño de la del perfil vacío
